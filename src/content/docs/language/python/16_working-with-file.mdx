...
The `write` method returns the number of <Color color="var(--secondary-font-color)"> characters </Color> written.
...
The `seek` function should be used when you open a file in <Color color="var(--secondary-font-color)"> binary mode </Color>.

</Aside>

<Aside type="danger" title="danger"> 

When you open a file <Color color="var(--secondary-font-color)"> in text mode </Color>, `open('file', 'r+t')`
