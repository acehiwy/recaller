...
<Aside type="tip" title="API reference">
...
![../../assets/page-without-layout.png](../../assets/page-without-layout.png)

</TabItem>
<TabItem value="withLayout" label="Page With Layout">

![../../assets/page-with-layout.png](../../assets/page-with-layout.png)
...
<Aside type="note" title="Excluding files from website paths">
