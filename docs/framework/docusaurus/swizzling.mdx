...
``` jsx title="src/theme/Footer/index.js" lines
...
``` jsx title="src/theme/SomeComponent.js" lines
import React from "react";
...
``` jsx title="src/theme/SomeComponent.js" lines highlight={2}
import React from "react";
import Footer from "@theme-original/Footer";
...
``` jsx title="src/theme/BlogPostItem.js" lines
import React from "react";
...
``` jsx title="src/theme/Root.js" lines
import React from "react";
