...
### <span style={{color: "var(--not-nesary-for-now-future-font-color)"}}> Alter SVG </span>
...
The ThemedImage component (included in the themes) allows you to <span style={{color: "var(--secondary-font-color)"}}> switch </span>
the <span style={{color: "var(--secondary-font-color)"}}> image source </span>
based on the <span style={{color: "var(--secondary-font-color)"}}> current theme </span>.
...
If a Markdown <span style={{color: "var(--secondary-font-color)"}}> link </span> or <span style={{color: "var(--secondary-font-color)"}}> image </span> has an <span style={{color: "var(--primary-font-color)"}}> absolute path </span>,
the path will be seen as a <span style={{color: "var(--secondary-font-color)"}}> file path </span> and will be <span style={{color: "var(--primary-font-color)"}}> resolved from the static directories </span>.
