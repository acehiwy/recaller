...
URL paths are <span style={{color: "var(--secondary-font-color)"}}> unprocessed </span> by Docusaurus, and you can see them as directly
...
If you want to reference another Markdown file <span style={{color: "var(--secondary-font-color)"}}> included by </span> <span style={{color: "var(--primary-font-color)"}}> the same plugin </span>,
you could use the <span style={{color: "var(--secondary-font-color)"}}> relative path </span> of the document you want to link to.

Docusaurus' Markdown loader will <span style={{color: "var(--secondary-font-color)"}}> convert </span> the <span style={{color: "var(--secondary-font-color)"}}> file path </span>
to the target <span style={{color: "var(--secondary-font-color)"}}> file's URL path </span> (and hence remove the .md extension).
...
``` markdown title="docs/floder/doc1.md" lines
...
Absolute file paths, on the other hand, are resolved <span style={{color: "var(--secondary-font-color)"}}> relative to the content root </span>,
...
### <span style={{color: "var(--not-require-but-good-to-know-font-color)"}}> Benefits of using file path </span>
...
- You can customize the files' slugs without having to update all the links
  - **<span style={{color: "var(--secondary-font-color)"}}> //\\\\ </span>** update markdown url without change its references in other files
