...
``` markdown title="_markdown-partial-example.mdx" lines
...
``` jsx title="someOtherDoc.mdx" lines
...
``` jsx title="fooPages.jsx" lines highlight={8-10}
...
``` javascript title="src/theme/MDXComponents.js" lines
import React from "react";
