...
Study in Anki is <span style={{color: "var(--secondary-font-color)"}}> limited to </span> the currently selected deck as well as any subdecks it contains.
...
- `New` refers to cards that you have downloaded or entered in, but have <span style={{color: "var(--secondary-font-color)"}}> never been studied </span> before.
- `Learning` refers to cards that were seen for the first time recently, and are <span style={{color: "var(--secondary-font-color)"}}> still being learnt </span>.
- `To Review` refers to cards that were <span style={{color: "var(--secondary-font-color)"}}> previously learnt </span>, and now <span style={{color: "var(--secondary-font-color)"}}> need to be reviewed </span> so you don't forget them.
...
but as a general rule if you <span style={{color: "var(--secondary-font-color)"}}> can't answer within about 10 seconds </span>, it's probably <span style={{color: "var(--secondary-font-color)"}}> better to give up </span> and show the answer than keep struggling to remember.

</Note>

When the answer is shown, you should compare the answer you thought of with the answer which is shown and <span style={{color: "var(--primary-font-color)"}}> tell Anki how well you remembered </span>.
...
&#8203;<span style={{color: "var(--writer-additional-note-font-color)"}}> //\\ </span> Each card
...
Each time you press `Good` during review, the card <span style={{color: "var(--secondary-font-color)"}}> moves to the next step </span>.
