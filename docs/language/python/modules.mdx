...
``` python title="some_other_file.py" lines
import my_module
...
``` python title="my_module.py" lines
def foo():
  return 'foo'
```
...
``` python title="middle_module.py" lines
print('init:' , __name__)
...
``` python title="deepest_module.py" lines
print('init:' , __name__)
...
``` python title="formats/__init__.py" lines
__all__ = [
  'waveread',
  'wavewrite'
]
